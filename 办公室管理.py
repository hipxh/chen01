...
def writeAnswer2(browser):
    ...
    #如下是正常操作,该套试卷形考1两道单选
    rightAnswer = getAnswerElement(elements1, "办公厅")
    rightAnswer.find_element_by_xpath("./..").find_element_by_xpath("./input").click()
    time.sleep(0.1)
    rightAnswer = getAnswerElement(elements1, "国务院")
    rightAnswer.find_element_by_xpath("./..").find_element_by_xpath("./input").click()
    time.sleep(0.1)
    rightAnswer = getAnswerElement(elements1, "塑造出组织文化及价值")
    rightAnswer.find_element_by_xpath("./..").find_element_by_xpath("./input").click()
    time.sleep(0.1)
    rightAnswer = getAnswerElement(elements1, "服务性")
    rightAnswer.find_element_by_xpath("./..").find_element_by_xpath("./input").click()
    time.sleep(0.1)
    rightAnswer = getAnswerElementEquals(elements1, "服务")#. 服务
    rightAnswer.find_element_by_xpath("./..").find_element_by_xpath("./input").click()
    time.sleep(0.1)
    rightAnswer = getAnswerElement(elements1, "中性笔")
    rightAnswer.find_element_by_xpath("./..").find_element_by_xpath("./input").click()
    time.sleep(0.1)
    rightAnswer = getAnswerElement(elements1, "发放人员要提醒")
    rightAnswer.find_element_by_xpath("./..").find_element_by_xpath("./input").click()
    time.sleep(0.1)
    rightAnswer = getAnswerElement(elements1, "判定需要订购")
    rightAnswer.find_element_by_xpath("./..").find_element_by_xpath("./input").click()
    time.sleep(0.1)
    rightAnswer = getAnswerElement(elements1, "名牌和")
    rightAnswer.find_element_by_xpath("./..").find_element_by_xpath("./input").click()
    time.sleep(0.1)
    rightAnswer = getAnswerElement(elements1, "国家级或")
    rightAnswer.find_element_by_xpath("./..").find_element_by_xpath("./input").click()
    time.sleep(0.1)
    #接下来10个判断题,因为顺序不可能变,所以可写死,前面占了40个ratio,所以41,44,45,47,50,52,54,55,58,59
