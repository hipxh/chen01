...
def getAnswerElementEquals(elements, neirong, i, meidaotiyouduoshaogexuanxiang):
    ...
    for ele in elements:#or "a. " + neirong == ele.text or "b. " + neirong == ele.text or "c. " + neirong == ele.text or "d. " + neirong == ele.text or "e. " + neirong == ele.text
        if neirong == ele.text or "A. " + neirong == ele.text or "B. " + neirong == ele.text or "C. " + neirong == ele.text or "D. " + neirong == ele.text or "E. " + neirong == ele.text:
            return ele
        if neirong == ele.text or "1. " + neirong == ele.text or "2. " + neirong == ele.text or "3. " + neirong == ele.text or "4. " + neirong == ele.text or "5. " + neirong == ele.text:
            return ele
        if neirong == ele.text or "a. " + neirong == ele.text or "b. " + neirong == ele.text or "c. " + neirong == ele.text or "d. " + neirong == ele.text or "e. " + neirong == ele.text:
            return ele
def getAnswerElementEqualsSpecial(elements, neirong, i, meidaotiyouduoshaogexuanxiang):
    # elements = elements[i * meidaotiyouduoshaogexuanxiang:(i + 2) * meidaotiyouduoshaogexuanxiang]
    for ele in elements:#or "a. " + neirong == ele.text or "b. " + neirong == ele.text or "c. " + neirong == ele.text or "d. " + neirong == ele.text or "e. " + neirong == ele.text
        if neirong == ele.text or "A. " + neirong == ele.text or "B. " + neirong == ele.text or "C. " + neirong == ele.text or "D. " + neirong == ele.text or "E. " + neirong == ele.text:
            return ele
        if neirong == ele.text or "1. " + neirong == ele.text or "2. " + neirong == ele.text or "3. " + neirong == ele.text or "4. " + neirong == ele.text or "5. " + neirong == ele.text:
...
#titleIndex     表示所有的题干
#danxuantiLength   表示前面单选题在的个数
#panduanIndex      表示判断题的个数
#ratios    表示所有的单选框
...
def writeAnswer1(browser):
    ...
    mulAnswer = '''21.混合式; 纠问式; 控告式
22.惩罚犯罪保护人民; 维护社会主义社会秩序; 保证刑法的正确实施; 保障国家安全和社会公共安全
23.对公安机关的侦查活动，依法实行监督;  对公安机关提请批准的案件，进行审查; 对直接受理的案件进行侦查
24.请求撤回自诉; 请求以调解结案; 要求同被告人和解
25.被告人的养父; 被告人的母亲; 对被告人负有保护责任的村长
26.有权委托诉讼代理人; 认为公安机关应当立案侦查而不立案时，可以要求人民检察院督促立案; 如果对不起诉决定不服，可以直接向人民法院起诉
27.必须在法律规定和被代理人授权范围内为代理行为; 只要不超越代理权限，其行为有一定自主性; 其行动如果没有被代理人的授权或同意，不具有法律效力
28.提供法律咨询; 为被逮捕的犯罪嫌疑人申请取保候审; 代理申诉、控告
29.撤销案件; 宣告无罪; 不起诉; 终止审理
30.未成年人犯罪的案件; 有关国家秘密的案件; 有关公民个人隐私的案件
31.贪污贿赂犯罪; 国家机关工作人员利用职权实施的非法拘禁犯罪; 国家机关工作人员利用职权实施的侵犯公民民主权利的犯罪
32.告诉才处理的案件;  被害人有证据证明的轻微刑事案件
33.危害国家安全案件; 判处死刑的案件; 判处无期徒刑的案件
34.书记员; 鉴定人员
35.审判长; 翻译人员; 书记员; 人民陪审员
36.在本案中担任证人; 接受当事人委托的人的请客送礼
37.未成年被告人的法定代理人; 被告人
38.被告人是未成年人的; 被告人是聋哑人的; 被告人是盲人的
39.被告人的朋友; 律师
40.公诉案件被害人的近亲属; 公诉案件的被害人; 附带民事诉讼的当事人
'''
    dxindex = 0
...
def writeAnswer2(browser):
    ...
    mulAnswer = '''21.鉴定结论的抄件; 被毁财物的复制品
22.甲吃、喝、嫖、赌，道德品质败坏; 甲在10年以前曾采用过与本案相同的手段实施过杀人行为(未遂，被判过刑)
23.现场发现的烟头;  沾有被害人血迹的衣服; 赃款;  被撬坏的门锁
24.不利于被告人的证据; 直接证据
25.构成犯罪事件的各种情节; 犯罪事实是否发生; 被告人的个人情况和犯罪后的表现
26.小颖的年龄; 小颖盗窃的事实; 小颖犯罪后的表现
27.有固定的住所和收入; 享有政治权利，人身自由未受到限制; 有能力履行保证义务; 与本案无牵连
28.责令具结悔过，重新交纳保证金; 监视居住; 予以逮捕
29.通缉在案的; 正在实行犯罪的; 正在被追捕的; 越狱逃跑的
30.被害人的法定代理人; 人民检察院; 被害人
31.对被告人的行为负有赔偿责任的组织; 刑事被告人; 刑事被告人的法定代理人
32.甲住院期间的误工费用;  甲医治精神恍惚支付的费用;  甲住院期间的陪护费用;  甲因住院支付的费用
33.留置送达的程序中无须见证人到场; 在找不到收件人，同时也找不到代收人时，才能采用留置送达
34.补充侦查完毕又起诉的; 公诉案件改变管辖的; 二审法院发回重审的
35.郑某的行为系故意; 该女婴已因溺水而死亡; 郑某作案时已满18周岁'''
    dxindex = 0
    mapmulAnswer = duoxuanAutoAnswerFix(mulAnswer, ".", "; ")
    for value in mapmulAnswer:
        for v in value:
    ...
    browser.find_element_by_id("tinymce").send_keys(
        "1.答：(1)公安机关可以对江某采取取保候审强制措施。《刑事诉讼法》第60 款规定:“对应当逮捕的犯罪嫌疑人、被告人,如果患有严重疾病,或者是正在怀孕、哺乳自己婴 儿的妇女,可以采用取保候审或者监视居住的办法。”本案 中,江某患有严重的肺结核,理应对其采取取保候审的强制 措施。(2)公安机关不同意江某之弟做保证人是正确的。《刑事诉 讼法》第54 条规定:“保证人必须符合下列条件:(一)与本 案无牵连;(二)有能力履行保证义;(三)享有政治权利,人 身自由未受到限制;(四)有固定的住处和收入。”本案中, 江某之弟无固定的住处,不符合第(二)(四)项规定,公安机 关不同意其做保证人的做法是正确的。(3)江某若无法提供别的保证人,可通过交纳保证金,而被 取保候审。《刑事诉讼法》第53 条规定:“人民法院、人民 检察院和公安机关决定对犯罪嫌疑人、被告人取保候审, 应当责令犯罪嫌疑人、被告人提出保证人或者交纳保证 金。”据此,我国的取保候审分人保和物保(财产保)两种, 若江某无法提供保证人,可选择财产保,交纳保证金。"
    )
...
#单选及多选(此方法需要优化一下，答案里面有带有p标签的没有勾选上，具体题目表现在 31，32，33，34 这几题)
def writeAnswer3(browser):
    ...
    mulAnswer = '''21.经特赦令免除刑罚; 犯罪已过追诉时效的
22.被害人; 犯罪嫌疑人
23.鉴定;  勘验、检查; 搜查
24.不起诉; 提起公诉; 撤销案件
...
29.是否附有证人名单; 是否附有证据目录; 是否有主要证据的复印件或照片; 是否有明确的指控犯罪事实
30.辩护律师因涉嫌伪证罪需追究刑事责任的，应当及时通知其所在的律师事务所或者所属的律师协会; 应当由A地公安机关以外的侦查机关侦查
31.危害国家安全犯罪; 黑社会性质的组织犯罪; 恐怖活动犯罪; 重大毒品犯罪
32.对于复杂、疑难案件，期限届满仍有必要继续采取技术侦查措施的，经过有权机关批准，有效期可以延长，每次自批准之日起三个月以内有效; 对于复杂、疑难案件，期限届满仍有必要继续采取技术侦查措施的，经过有权机关批准，有效期可以延长，但最多不超过两个月; 批准技术侦查的决定自签发第二日起三个月内有效; 对于复杂、疑难案件，期限届满仍有必要继续采取技术侦查措施的，经过上一级侦查机关批准，有效期可以延长 
33.对采取技术侦查措施获取的与案件无关的材料，必须及时销毁; 侦查人员对采取技术侦查措施过程中知悉的国家秘密、商业秘密和个人隐私，应当保密; 采取技术侦查措施获取的材料，只能用于对犯罪的侦查、起诉和审判，不得用于其他用途
34.本案中王某的侦查方式属于诱惑侦查，是不可行的; 隐匿身份对农民甲实施侦查，需经过公安机关负责人决定; 王某与某甲约定交货时间，到县城一宾馆内与"老板"（侦查人员）交易。当王某带甲前往交易时，被侦查人员人赃俱获，此即为控制下交付
...
def writeAnswer4(browser):
    ...
    mulAnswer = '''21.是否附有证据目录; 是否附有证人名单; 是否有明确的指控犯罪事实; 是否有主要证据的复印件或照片
22.被害人; 诉讼代理人; 辩护人
23.冻结;  查询; 检查;  扣押
24.罚款; 拘留; 强行带出法庭; 警告制止
25.需要通知新的证人到庭的; 需要重新鉴定和勘验的; 需调取新的物证的
26.犯罪已过追诉时效期间的; 被告人死亡的
27.犯罪后果轻微，社会危害性不大; 案件事实清楚，情节简单.无需侦查; 有明确的被告和原告
28.自诉人可在判决宣告以前撤回自诉; 人民法院对自诉案件可以进行调解; 被告人可提出反诉
29.简易程序可以变更为第一审普通程序; 审判员一人独任审判; 公诉案件检察人员可以不出庭
30.开庭审理; 调查询问式审理
31.只有被告人的近亲属上诉的案件; 只有被告人上诉的案件
32.第二审人民法院开庭审理的公诉案件;  人民检察院抗诉的案件;  第二审人民法院不公开审理的公诉案件
33.高级人民法院核准的死刑缓期二年执行判决; 已过法定期限没有上诉.抗诉的判决和裁定; 终审的判决和裁定; 最高人民法院核准的死刑判决
34.因本案存在抗诉，二审法院对甲和乙都不受上诉不加刑原则的限制; 二审法院可以不开庭审理; 因上诉和抗诉都不是针对原审事实认定，二审法院对本案不能以事实不清为由撤销原判，发回重审
35.提起公诉的检察院; 当事人; 辩护人; 诉讼代理人'''
    dxindex = 0
    mapmulAnswer = duoxuanAutoAnswerFix(mulAnswer, ".", "; ")
    for value in mapmulAnswer:
        for v in value:
    ...
    browser.switch_to.frame(frameId + ":36_answer_id_ifr")
    browser.find_element_by_id("tinymce").send_keys(
        "答：1.李某可以书面或者口头的形式，直接向二审人民法院提出上诉，也可以通过原审人民法院提出上诉。2.人民检察院可以提起抗诉。抗诉的程序是：意识抗诉的体提出。抗诉的提出是指哪一级别的人民法院已经发生法律效力的判决，裁定，可以向哪一级别的人民法院提出的抗诉。根据我国民事诉讼法的规定，最高人民检察院对各级人民法院已经发生法律效力的判决，裁定，上级人民检察院对下级人民法院已经发生效力的判决，裁定，可以提出抗诉；地方各级人民检察院已发生法律效力的判决，裁定，不得直接提出抗诉，只能提请上级人民检察院提出抗诉。而是抗诉的方式，抗诉的方式是指人民检察院对人民法院的生效裁判提出抗诉采取的方式。人民检察院决定对人民法院的生效裁判提出抗诉的，应当制作抗诉书。抗诉书是人民检察院对人民法院的生效裁判提出抗诉的法律文书，也是人民检察院行使检查监督权引起对抗诉案件再行审理的法律文书。抗诉书中应载明：提出抗诉的人民检察院和接受抗诉的人民法院；抗诉案件的原审法院对案件的编号及其发生法律效力的判决，裁定；抗诉的事实和理由；提出抗诉的时间。有证据的，人民检察院向人民法院提交抗诉书的同时，可以向人民法院提供证据，或者提供证据来源。人民检察院提出抗诉的案件，人民法院应当再审，即只要人民检察院提出抗诉，人民法院就应当直接进行再审，并不需要院长提交审判委员会讨论。3.二审法院的做法合理。刑诉法底二百二十五条第一项规定，原判决认定事实和适用法律正确，量刑适当的，二审法院应当裁定驳回上诉，维持原判，本案中，虽然原审人民法院在认定盗窃数额时与实际不符，少认定2110元，但案件基本事实和适用法律均无错误。故二审法院裁定驳回李某上诉，维持原判是正确的。4.做法是错误的。依照《刑事诉讼法》第二百四十三条第一款的规定，各级人民法院院长对本院已经发生法律效力的判决和裁定，如果发现在认定事实上或者在适用法律上确有错误，必须提交审判委员会处理。因此，二审法院院长认为此案在认定事实上确有错误，必须提交审判委员会处理。院长本人不能以院长名义撤销本院对此案的裁定，不能自行决定零星组成合议庭审理此案。所以，本案院长的做法显然是错误的。5，不违反“上诉不加刑”原则。因为刑诉法规定人民检察院提出抗诉的，不受规定的闲置，本案中，在检察机关提出抗诉的情况下，二审法院可直接改判家中被告人李某的刑罚，不违反“上诉不加刑”原则。"
    )
    browser.switch_to.default_content()
...
def writeAnswer5(browser):
    ...
    mulAnswer = '''21.原判决、裁定适用法律确有错误的; 据以定罪量刑的证据不确实、不充分，依法应当予以排除的; 审判人员在审理该案件时有贪污受贿、枉法裁判行为的; 违反法律规定的诉讼程序，可能影响公正审判的; 有新的证据证明原判决、裁定认定的事实确有错误，可能影响定罪量刑的
22.撤销原判，用判决予以改判; 按照第二审程序审理的案件，认为必须判处被告人死刑立即执行的，直接改判后，应当报请最高人民法院核准
23.核准死刑立即执行的机关是最高人民法院; 王某由作出一审判决的法院执行
24.发现关键定罪证据可能是刑讯逼供所得; 提供一重大银行抢劫案线索，经查证属实; 罪犯正在怀孕; 判决书认定的年龄错误，实际年龄未满18周岁
25.被判处无期徒刑的女罪犯张某，被发现服则时怀有身孕; 被判处拘役的罪犯李某患有严重疾病需要保外就医; 被判处5年有期徒刑的妇女赵某，服刑时其宁正值哺乳期
26.暂予监外执行的情形消失后，罪犯刑期未满的; 不符合暂予监外执行条件的罪犯通过贿赂等非法手段被暂予监外执行的; 严重违反有关暂予监外执行监督管理规定的
27.被判处拘役的罪犯李某患有严重疾病需要保外就医; 被判处有期徒刑10年的罪犯王某，在狱中自杀未遂，致使生活不能自理; 被判处无期徒刑的女罪犯张某，被发现服刑时怀有身孕
28.对于被判处有期徒刑的罪犯，剩余刑期在六个月以下的，由看守所代为执行; 第一审人民法院判决被告人免除刑事处罚的，如果被告人在押，在判决生效后应当立即释放
29.二者均可以由各级检察院提起; 二者均由抗诉的检察院向同级法院提起; 二者的抗诉对象均是确有错误的判决、裁定; 二者均可以由地方各级检察院提起
30.最高人民检察院; 该省高级人民法院
31.被害人温某; 王某的成年胞兄; 王某的父亲
32.未成年人刑事案件，是指被告人实施被指控的犯罪时已满14周岁不满18周岁的案件;  16岁以上不满18岁未成年人犯罪的案件，一般不公开审理;  公安机关对羁押的未成年人应当与羁押的成年人分别看管
33.省人民检察院; 最高人民检察院
34.甲市中级人民法院有权决定提审; 省高级人民法院有权指令区人民法院再审
35.应当听取辩护人的意见; 应当听取未成年被害人的法定代理人的意见; 在押的未成年犯罪嫌疑人有认罪、悔罪表现的，检察人员可以安排其与法定代理人、近亲属等会见、通话; 应当听取未成年被害人的意见'''
    dxindex = 0
    mapmulAnswer = duoxuanAutoAnswerFix(mulAnswer, ".", "; ")
    for value in mapmulAnswer:
        for v in value:
            anEle = getAnswerElementEqualsSpecial(elements1, v.strip(), dxindex, 4)  # 找到指定的那个label选项
            if anEle is not None:
                anEle.find_element_by_xpath("./../input[last()]").click()
                time.sleep(0.1)
        dxindex += 1
